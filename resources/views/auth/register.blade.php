                    ...
                    <div class="header-body text-center mb-7">
                        <div class="row justify-content-center">
                            <div class="col-xl-5 col-lg-6 col-md-8 px-5">
                                ...
                                <p class="text-lead text-white">Daftarkan akun <span class="fw-bold">COBLOS</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-7">
                    <div class="card" style="background-color: rgb(191, 248, 245)">
                        <div class="card-header">
                            <p class="fs-3 fw-bold">Register</p>
                        </div>
                        <div class="card-body">
                            <form method="POST" autocomplete="on" action="{{ route('register') }}">
                                ...
                                <div class="form-group">
                                    <button type="submit" class="btn btn-success btn-sm fw-bold m-2"
                                        style="float: right" name="submit" value="submit">Daftar</button>
                    ...
                    <div class="row mt-3">
                        <div class="col-6">
                            <a href="{{ route('login') }}" class="text-light fs-5"><small>Sudah punya akun?
                                    Masuk!</small></a>
                        </div>
                    </div>
                </div>
