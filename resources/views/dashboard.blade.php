...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Tables -->
            <li class="nav-item">
                <a class="nav-link" href="{{ route('view.create.survey') }}">
            ...
            <div id="content">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <i class="far fa-user-circle mr-2 fa-2x"></i>
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h3 class="text-secondary fw-bold">Selamat Datang <span class="text-dark">{{ $user }} 😀</span>
                    </div>
                ...
                <div class="card-body">
                    <table class="table table-stripped">
                        ...
                        @else
                            <div>
                                <p class="card-text">Tidak ada survey!</p>
                            </div>
                        @endif
                    </table>
                </div>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; COBLOS - 2021</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
