...
Route::get('/survey-response/{id}', [SurveyController::class, 'showResponseSurvey'])->name('view.response.survey');
...
Route::post('/survey-response/{id}', [SurveyController::class, 'responseSurvey'])->name('response.survey');
